 ...
 * has L local values, like following, the stack will be used as following
 * table. <pre>{@code function func(arg0, arg1, ..., argA) { var local0, local1,
 * ..., localL; return (return0, return1, ..., returnR);
 * }
 * }</pre>
 * <pre>
 * +-------------+-------------+----------------+
...
#define WASMBOX_ADD_ARGUMENT(STACK, INDEX, TYPE, V)                 \
  do {                                                              \
